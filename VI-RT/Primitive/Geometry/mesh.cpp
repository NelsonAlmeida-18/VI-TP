...
bool Mesh::TriangleIntersect (Ray r, Face f, Intersection *isect) {
    ...
    //std::cout << "Ray cross e2 " << ray_cross_e2.X << " " << ray_cross_e2.Y << " " << ray_cross_e2.Z << std::endl;
    ...
    // std::cout << "ray origin" << r.o.X << " " << r.o.Y << " " << r.o.Z << std::endl;
    // std::cout << "Value U " << u << std::endl;
    ...
    float v = dot * invDet;
    //std::cout << "Value dot " << dot << std::endl;


    //std::cout << "Value v " << v << std::endl;

    if (v < 0 || u + v > 1) return false;
    // std::cout << "Value invDet " << invDet << std::endl;
    // std::cout << "ray origin" << r.o.X << " " << r.o.Y << " " << r.o.Z << std::endl;
    // std::cout << "Vector s " << s.X << " " << s.Y << " " << s.Z << std::endl;
