...
# INCLUDE  := -IVI-RT/Camera/ -IVI-RT/Image -IVI-RT/Light -IVI-RT/Primitive -IVI-RT/Primitive/BRDF -IVI-RT/Primitive/Geometry -IVI-RT/Rays -IVI-RT/Renderer -IVI-RT/Scene -IVI-RT/Shader -IVI-RT/utils -IVI-RT/Image/mozjpeg/ -IVI-RT/Image/miniz/ -IVI-RT/Image/tinyexr-1.0.8/  -IVI-RT/Image/tinyexr-1.0.8/examples/common/  -IVI-RT/Image/tinyexr-1.0.8/deps/miniz/  -IVI-RT/Scene/tinyobjloader/
...
# Added paths for tinyexr.cc and miniz.o
TINYEXR_PATH := ./VI-RT/Image/tinyexr-1.0.8/tinyexr.cc
MINIZ_O_PATH := ./VI-RT/Image/tinyexr-1.0.8/deps/miniz/miniz.o

INCLUDE  := -IVI-RT/Camera/ -IVI-RT/Image -IVI-RT/Light -IVI-RT/Primitive -IVI-RT/Primitive/BRDF -IVI-RT/Primitive/Geometry -IVI-RT/Rays -IVI-RT/Renderer -IVI-RT/Scene -IVI-RT/Shader -IVI-RT/utils -IVI-RT/Image/mozjpeg/ -IVI-RT/Image/miniz/ -IVI-RT/Image/tinyexr-1.0.8/  -IVI-RT/Image/tinyexr-1.0.8/examples/common/    -IVI-RT/Scene/tinyobjloader/
